...
namespace WPfDocEleks.ServiceDocEleks {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceDocEleks.IServiceDocEleksDB")]
    public interface IServiceDocEleksDB {
        ...
        int InsertUser(WPfDocEleks.ServiceDocEleks.User user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceDocEleksDB/InsertUser", ReplyAction="http://tempuri.org/IServiceDocEleksDB/InsertUserResponse")]
        System.Threading.Tasks.Task<int> InsertUserAsync(WPfDocEleks.ServiceDocEleks.User user);
        ...
        int ValidUser(WPfDocEleks.ServiceDocEleks.User user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceDocEleksDB/ValidUser", ReplyAction="http://tempuri.org/IServiceDocEleksDB/ValidUserResponse")]
        System.Threading.Tasks.Task<int> ValidUserAsync(WPfDocEleks.ServiceDocEleks.User user);
        ...
        int ValidUserName(WPfDocEleks.ServiceDocEleks.User user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceDocEleksDB/ValidUserName", ReplyAction="http://tempuri.org/IServiceDocEleksDB/ValidUserNameResponse")]
        System.Threading.Tasks.Task<int> ValidUserNameAsync(WPfDocEleks.ServiceDocEleks.User user);
        ...
        int InsertContact(WPfDocEleks.ServiceDocEleks.Contact contact);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceDocEleksDB/InsertContact", ReplyAction="http://tempuri.org/IServiceDocEleksDB/InsertContactResponse")]
        System.Threading.Tasks.Task<int> InsertContactAsync(WPfDocEleks.ServiceDocEleks.Contact contact);
        ...
        int UpdateContact(WPfDocEleks.ServiceDocEleks.Contact contact);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceDocEleksDB/UpdateContact", ReplyAction="http://tempuri.org/IServiceDocEleksDB/UpdateContactResponse")]
        System.Threading.Tasks.Task<int> UpdateContactAsync(WPfDocEleks.ServiceDocEleks.Contact contact);
        ...
        WPfDocEleks.ServiceDocEleks.Contact[] GetAllContacts(short userId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceDocEleksDB/GetAllContacts", ReplyAction="http://tempuri.org/IServiceDocEleksDB/GetAllContactsResponse")]
        System.Threading.Tasks.Task<WPfDocEleks.ServiceDocEleks.Contact[]> GetAllContactsAsync(short userId);
        ...
        short GetUserId(WPfDocEleks.ServiceDocEleks.User user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceDocEleksDB/GetUserId", ReplyAction="http://tempuri.org/IServiceDocEleksDB/GetUserIdResponse")]
        System.Threading.Tasks.Task<short> GetUserIdAsync(WPfDocEleks.ServiceDocEleks.User user);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceDocEleksDBChannel : WPfDocEleks.ServiceDocEleks.IServiceDocEleksDB, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceDocEleksDBClient : System.ServiceModel.ClientBase<WPfDocEleks.ServiceDocEleks.IServiceDocEleksDB>, WPfDocEleks.ServiceDocEleks.IServiceDocEleksDB {
        ...
        public int InsertUser(WPfDocEleks.ServiceDocEleks.User user) {
            return base.Channel.InsertUser(user);
        }
        
        public System.Threading.Tasks.Task<int> InsertUserAsync(WPfDocEleks.ServiceDocEleks.User user) {
            return base.Channel.InsertUserAsync(user);
        }
        
        public int ValidUser(WPfDocEleks.ServiceDocEleks.User user) {
            return base.Channel.ValidUser(user);
        }
        
        public System.Threading.Tasks.Task<int> ValidUserAsync(WPfDocEleks.ServiceDocEleks.User user) {
            return base.Channel.ValidUserAsync(user);
        }
        
        public int ValidUserName(WPfDocEleks.ServiceDocEleks.User user) {
            return base.Channel.ValidUserName(user);
        }
        
        public System.Threading.Tasks.Task<int> ValidUserNameAsync(WPfDocEleks.ServiceDocEleks.User user) {
            return base.Channel.ValidUserNameAsync(user);
        }
        
        public int InsertContact(WPfDocEleks.ServiceDocEleks.Contact contact) {
            return base.Channel.InsertContact(contact);
        }
        
        public System.Threading.Tasks.Task<int> InsertContactAsync(WPfDocEleks.ServiceDocEleks.Contact contact) {
        ...
        public int UpdateContact(WPfDocEleks.ServiceDocEleks.Contact contact) {
            return base.Channel.UpdateContact(contact);
        }
        
        public System.Threading.Tasks.Task<int> UpdateContactAsync(WPfDocEleks.ServiceDocEleks.Contact contact) {
            return base.Channel.UpdateContactAsync(contact);
        }
        
        public WPfDocEleks.ServiceDocEleks.Contact[] GetAllContacts(short userId) {
            return base.Channel.GetAllContacts(userId);
        }
        
        public System.Threading.Tasks.Task<WPfDocEleks.ServiceDocEleks.Contact[]> GetAllContactsAsync(short userId) {
        ...
        public short GetUserId(WPfDocEleks.ServiceDocEleks.User user) {
            return base.Channel.GetUserId(user);
        }
        
        public System.Threading.Tasks.Task<short> GetUserIdAsync(WPfDocEleks.ServiceDocEleks.User user) {
